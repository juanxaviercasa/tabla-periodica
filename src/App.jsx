...
function Home() {
  ...
  return <main>
    ...
    <section className="pathways" aria-label="Rutas de aprendizaje"><Link to={`/quiz/${nextTopic.id}`}><span className="eyebrow">Ruta Examen</span><strong>Practica con foco</strong><small>Preguntas, valencias y velocidad para tu próxima evaluación.</small></Link><Link to="/laboratorio"><span className="eyebrow">Ruta Comprensión</span><strong>Explora el laboratorio</strong><small>Construye átomos y conecta estructura con comportamiento.</small></Link><Link to="/docentes"><span className="eyebrow">Para acompañar</span><strong>Vista docente</strong><small>Observa progreso y conceptos que necesitan intervención.</small></Link></section>
