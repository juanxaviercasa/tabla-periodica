// isotopesData.js - Grounded dataset for isotopic abundance and weighted average atomic mass
// Based on IUPAC / PhET Interactive Simulations frameworks

export const isotopesData = {
  "H": {
    "symbol": "H",
    "name": "Hidrógeno",
    "z": 1,
    ...
    "isotopes": [
      {
        ...
        "neutrons": 0,
        "mass_u": 1.0078,
        "abundance_pct": 99.985,
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "El único núcleo sin neutrones"
      },
      {
        "name": "Deuterio",
        "symbol": "²H",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Forma el agua pesada (D₂O) en reactores"
      },
      {
        "name": "Tritio",
        "symbol": "³H",
        ...
        "is_stable": false,
        "decay_mode": "Beta negativa (β⁻)",
        "highlight": "Radiactivo, vida media 12.3 años"
      }
    ],
    "calculation_steps": [
    ...
    "isotopes": [
      {
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Patrón de masa atómica internacional (exactamente 12 u)"
      },
      {
        "name": "Carbono-13",
        "symbol": "¹³C",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Usado en espectroscopía de RMN biológica"
      },
      {
        "name": "Carbono-14",
        "symbol": "¹⁴C",
        ...
        "is_stable": false,
        "decay_mode": "Beta negativa (β⁻)",
        "highlight": "Datación de restos fósiles (vida media 5730 años)"
      }
    ],
    "calculation_steps": [
      "1. Ā = (m(¹²C) × % + m(¹³C) × %) / 100",
    ...
    "isotopes": [
      {
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Isótopo más abundante (~3 de cada 4 átomos de cloro)"
      },
      {
        "name": "Cloro-37",
        "symbol": "³⁷Cl",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Isótopo pesado (~1 de cada 4 átomos de cloro)"
      }
    ],
    "calculation_steps": [
    ...
    "isotopes": [
      {
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "El más abundante (~69.15%)"
      },
      {
        "name": "Cobre-65",
        "symbol": "⁶⁵Cu",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Isótopo pesado con 36 neutrones (~30.85%)"
      }
    ],
    "calculation_steps": [
    ...
    "isotopes": [
      {
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Núcleo con N=12 y Z=12 (número par-par muy estable)"
      },
      {
        "name": "Magnesio-25",
        "symbol": "²⁵Mg",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Isótopo con 13 neutrones"
      },
      {
        "name": "Magnesio-26",
        "symbol": "²⁶Mg",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Isótopo con 14 neutrones"
      }
    ],
    "calculation_steps": [
    ...
    "isotopes": [
      {
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "50.69% de abundancia natural"
      },
      {
        "name": "Bromo-81",
        "symbol": "⁸¹Br",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "49.31% de abundancia natural"
      }
    ],
    "calculation_steps": [
  ...
  "Fe": {
    ...
    "isotopes": [
      ...
      },
      {
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Núcleo estelar de máxima estabilidad (91.75%)"
      },
      {
        "name": "Hierro-57",
        "symbol": "⁵⁷Fe",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Espectroscopía Mössbauer"
      },
      {
        "name": "Hierro-58",
        "symbol": "⁵⁸Fe",
    ...
    "isotopes": [
      {
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Único isótopo natural (100% monoisotópico)"
      },
      {
        "name": "Cobalto-60",
        "symbol": "⁶⁰Co",
        ...
        "abundance_pct": 0.0,
        "is_stable": false,
        "decay_mode": "Beta negativa (β⁻) y gamma (γ)",
        "highlight": "Radioisótopo en radioterapia y medicina nuclear (t½ = 5.27 años)"
      }
    ],
    "calculation_steps": [
    ...
    "isotopes": [
      {
        ...
        "neutrons": 8,
        "mass_u": 15.9949,
        "abundance_pct": 99.757,
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Núcleo doblemente mágico (Z=8, N=8), ultra estable"
      },
      {
        "name": "Oxígeno-17",
        "symbol": "¹⁷O",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Isótopo minoritario con espín nuclear"
      },
      {
        "name": "Oxígeno-18",
        "symbol": "¹⁸O",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Trazador isotópico en paleoclimatología e hidrología"
      }
    ],
    "calculation_steps": [
    ...
    "isotopes": [
      {
        ...
        "neutrons": 7,
        "mass_u": 14.0031,
        "abundance_pct": 99.636,
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Abundancia dominante en la atmósfera terrestre"
      },
      {
        "name": "Nitrógeno-15",
        "symbol": "¹⁵N",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Isótopo pesado utilizado como trazador biológico"
      }
    ],
    "calculation_steps": [
    ...
    "isotopes": [
      {
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Absorbedor neutrónico y precursor de tritio"
      },
      {
        "name": "Litio-7",
        "symbol": "⁷Li",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Isótopo primordial dominante en sales de litio"
      }
    ],
    "calculation_steps": [
    ...
    "isotopes": [
      {
        ...
        "abundance_pct": 0.72,
        "is_stable": false,
        "decay_mode": "Alfa (α), fisionable (t½ = 704 Ma)",
        "highlight": "Combustible nuclear fisionable indispensable"
      },
      {
        "name": "Uranio-238",
        "symbol": "²³⁸U",
        ...
        "neutrons": 146,
        "mass_u": 238.0508,
        "abundance_pct": 99.274,
        "is_stable": false,
        "decay_mode": "Alfa (α), fértil (t½ = 4468 Ma)",
        "highlight": "Isótopo natural predominante (no fisionable directamente)"
      },
      {
        "name": "Uranio-234",
        "symbol": "²³⁴U",
        ...
        "abundance_pct": 0.006,
        "is_stable": false,
        "decay_mode": "Alfa (α) (t½ = 245 ka)",
        "highlight": "Producto de la serie radiactiva del U-238"
      }
    ],
    "calculation_steps": [
    ...
    "isotopes": [
      {
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Único isótopo de plomo no radiogénico"
      },
      {
        "name": "Plomo-206",
        "symbol": "²⁰⁶Pb",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Producto final de la serie radiactiva del Uranio-238"
      },
      {
        "name": "Plomo-207",
        "symbol": "²⁰⁷Pb",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Producto final de la serie del Uranio-235"
      },
      {
        "name": "Plomo-208",
        "symbol": "²⁰⁸Pb",
        ...
        "is_stable": true,
        "decay_mode": "Estable",
        "highlight": "Doble número mágico (Z=82, N=126); fin de la serie del Torio-232"
      }
    ],
    "calculation_steps": [
...
export function getElementIsotopes(symbol) {
  if (!symbol) return null;
  const s = String(symbol).trim();
  const titleSym = s.charAt(0).toUpperCase() + s.slice(1).toLowerCase();
  return isotopesData[titleSym] || isotopesData[s] || null;
}
