// pedagogyData.js - Grounded Pedagogical Database for Pre-University Admission (UNMSM, UNI)
// Built according to IUPAC standards, lmmentel/mendeleev, Bowserinator, and PhET/RSC frameworks.
...
export const pedagogyData = {
  ...
  "21": {
    ...
    "z": 21,
    "pedagogy": {
      "everyday_context": "Metal de transición del bloque d con elevada dureza, alto punto de fusión y buena conductividad eléctrica y térmica. Usado en aleaciones estructurales y catálisis química.",
      "exam_pitfall": "Presenta múltiples estados de oxidación debido a la participación de los electrones (n-1)d y ns en el enlace químico. Al ionizarse pierde primero los electrones del nivel exterior s.",
      "quantum_breakdown": {
        "level_explanation": "Configuración electrónica con subnivel d en proceso de llenado. Muchas de sus sales presentan colores característicos en solución acuosa por transiciones d-d.",
        "anomalies_or_rules": "Forma complejos de coordinación con ligandos neutros o aniónicos, y cationes de radio intermedio."
      },
      "family_relationship": "Comparte propiedades típicas de metales pesados: brillo metálico, maleabilidad, ductilidad y estados de valencia variables.",
      "misconception": "Creer que al oxidarse el átomo pierde electrones del subnivel d antes que del nivel s exterior.",
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Escandio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Escandio (Sc, Z=21).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Escandio (Sc).",
  ...
  "22": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Titanio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Titanio (Ti, Z=22).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Titanio (Ti).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "23": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Vanadio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Vanadio (V, Z=23).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Vanadio (V).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "31": {
    ...
    "z": 31,
    "pedagogy": {
      "everyday_context": "Metal post-transición del bloque p, de densidad moderada y enlaces metálicos más suaves que los metales de transición puros. Utilizado en aleaciones ligeras y componentes industriales.",
      "exam_pitfall": "Sus puntos de fusión y ebullición son notablemente inferiores a los de los metales de transición del mismo período. Puede presentar carácter anfótero en sus óxidos.",
      "quantum_breakdown": {
        "level_explanation": "Configuración electrónica de bloque p terminal con subnivel d interno completamente lleno.",
        "anomalies_or_rules": "Afectado por el efecto de par inerte en los períodos 5 y 6, estabilizando estados de oxidación dos unidades inferiores al número de grupo."
      },
      "family_relationship": "Comparte con el Aluminio, Galio e Indio el carácter metálico en el bloque p.",
      "misconception": "Pensar que todos los metales son duros y refractarios; los metales post-transición suelen ser blandos y de bajo punto de fusión.",
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Galio?",
          "answer": "Al bloque p (metales del bloque p o post-transición).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Galio (Ga, Z=31).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué tendencia presentan los puntos de fusión de los metales post-transición frente a los metales de transición?",
          "answer": "Son significativamente más bajos debido a un enlace metálico menos rígido.",
          "explanation": "Fundamento analítico de examen de admisión para Galio (Ga).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "32": {
    ...
    "z": 32,
    "pedagogy": {
      "everyday_context": "Metaloide con propiedades intermedias entre metales y no metales, con comportamiento de semiconductor eléctrico ideal para circuitos electrónicos y óptica avanzada.",
      "exam_pitfall": "Presenta enlaces covalentes de red y electronegatividad intermedia. Su comportamiento ácido-base en óxidos suele ser anfótero o débilmente ácido.",
      "quantum_breakdown": {
        "level_explanation": "Configuración de bloque p. Sus electrones de valencia están ligados a energías intermedias, permitiendo conducción térmica y eléctrica bajo estímulo de voltaje o temperatura.",
        "anomalies_or_rules": "Define la frontera diagonal de la tabla periódica que separa a los metales electropositivos de los no metales electronegativos."
      },
      "family_relationship": "Comparte características con el Silicio y Germanio: aspecto metálico pero fragilidad mecánica y conducción semiconductora.",
      "misconception": "Creer que los metaloides son metales impuros; son elementos puros con bandas energéticas intermedias únicas.",
      "self_check_quiz": [
        {
          "question": "¿Qué propiedad eléctrica caracteriza a los metaloides como el Germanio?",
          "answer": "Son semiconductores: su conductividad eléctrica es moderada y aumenta al elevar la temperatura o por dopaje.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Germanio (Ge, Z=32).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Dónde se ubican los metaloides en la tabla periódica?",
          "answer": "En la línea diagonal divisoria que separa a los metales (a la izquierda) de los no metales (a la derecha).",
          "explanation": "Fundamento analítico de examen de admisión para Germanio (Ge).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "33": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿Qué propiedad eléctrica caracteriza a los metaloides como el Arsénico?",
          "answer": "Son semiconductores: su conductividad eléctrica es moderada y aumenta al elevar la temperatura o por dopaje.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Arsénico (As, Z=33).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Dónde se ubican los metaloides en la tabla periódica?",
          "answer": "En la línea diagonal divisoria que separa a los metales (a la izquierda) de los no metales (a la derecha).",
          "explanation": "Fundamento analítico de examen de admisión para Arsénico (As).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "36": {
    ...
    "z": 36,
    "pedagogy": {
      "everyday_context": "Gas inerte monatómico de baja reactividad, utilizado en iluminación de descarga, atmósfera protectora en procesos de alta tecnología y criogenia.",
      "exam_pitfall": "Posee capa de valencia cerrada y máxima energía de ionización en su período. En exámenes preuniversitarios su reactividad estándar se considera nula.",
      "quantum_breakdown": {
        "level_explanation": "Configuración electrónica de octeto completo ns² np⁶ (salvo el Helio que es 1s²). Todos los orbitales están totalmente apareados (diamagnético).",
        "anomalies_or_rules": "Fuerzas intermoleculares débiles de dispersión de London exclusivas; sus puntos de ebullición son los más bajos de sus períodos."
      },
      "family_relationship": "Comparte con Ne, Ar, Kr y Xe la estructura de capa completa y su condición de gases monatómicos inertes.",
      "misconception": "Creer que los gases nobles forman redes cristalinas en condiciones normales; son moléculas monatómicas aisladas.",
      "self_check_quiz": [
        {
          "question": "¿Por qué el Kriptón no forma compuestos químicos en condiciones ambientales?",
          "answer": "Porque posee su capa electrónica de valencia completamente saturada (octeto cerrado), con altísima energía de ionización y afinidad electrónica desfavorable.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Kriptón (Kr, Z=36).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Cuántos electrones desapareados contiene un átomo neutro de Kriptón?",
          "answer": "Cero electrones desapareados; es una especie totalmente diamagnética.",
          "explanation": "Fundamento analítico de examen de admisión para Kriptón (Kr).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "37": {
    ...
    "z": 37,
    "pedagogy": {
      "everyday_context": "Metal alcalino blando de gran reactividad química, manipulado bajo atmósfera inerte o queroseno. Empleado en aleaciones reductoras y aplicaciones de transferencia térmica.",
      "exam_pitfall": "Reacciona enérgicamente con agua produciendo hidróxidos solubles M(OH) y desprendiendo gas hidrógeno inflamable. Su estado de oxidación es estrictamente +1.",
      "quantum_breakdown": {
        "level_explanation": "Configuración electrónica terminal ns¹ con 1 electrón de valencia en la capa exterior. Al ionizarse pierde este electrón formando cationes monovalentes con kernel de gas noble.",
        "anomalies_or_rules": "Aumenta fuertemente su radio atómico y disminuye su energía de ionización conforme se desciende en el Grupo 1 debido al apantallamiento creciente de capas electrónicas internas."
      },
      "family_relationship": "Comparte con el Litio, Sodio y Potasio el estado de oxidación único de +1, baja dureza y marcada electropositividad.",
      "misconception": "Creer que la reactividad disminuye con el aumento de masa; en los alcalinos ocurre exactamente lo opuesto: son más reactivos hacia el fondo del grupo.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación característico del Rubidio en todos sus compuestos químicos?",
          "answer": "Estado de oxidación +1 (catión Rb⁺).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Rubidio (Rb, Z=37).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué gas se desprende cuando un metal alcalino como el Rubidio entra en contacto con agua líquida?",
          "answer": "Gas dihidrógeno (H₂), generándose simultáneamente el hidróxido correspondiente.",
          "explanation": "Fundamento analítico de examen de admisión para Rubidio (Rb).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "39": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Itrio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Itrio (Y, Z=39).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Itrio (Y).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "40": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Circonio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Circonio (Zr, Z=40).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Circonio (Zr).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "41": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Niobio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Niobio (Nb, Z=41).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Niobio (Nb).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "42": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Molibdeno?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Molibdeno (Mo, Z=42).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Molibdeno (Mo).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "43": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Tecnecio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Tecnecio (Tc, Z=43).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Tecnecio (Tc).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "44": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Rutenio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Rutenio (Ru, Z=44).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Rutenio (Ru).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "45": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Rodio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Rodio (Rh, Z=45).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Rodio (Rh).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "46": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Paladio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Paladio (Pd, Z=46).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Paladio (Pd).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "48": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Cadmio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Cadmio (Cd, Z=48).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Cadmio (Cd).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "49": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Indio?",
          "answer": "Al bloque p (metales del bloque p o post-transición).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Indio (In, Z=49).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué tendencia presentan los puntos de fusión de los metales post-transición frente a los metales de transición?",
          "answer": "Son significativamente más bajos debido a un enlace metálico menos rígido.",
          "explanation": "Fundamento analítico de examen de admisión para Indio (In).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "51": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿Qué propiedad eléctrica caracteriza a los metaloides como el Antimonio?",
          "answer": "Son semiconductores: su conductividad eléctrica es moderada y aumenta al elevar la temperatura o por dopaje.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Antimonio (Sb, Z=51).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Dónde se ubican los metaloides en la tabla periódica?",
          "answer": "En la línea diagonal divisoria que separa a los metales (a la izquierda) de los no metales (a la derecha).",
          "explanation": "Fundamento analítico de examen de admisión para Antimonio (Sb).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "52": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿Qué propiedad eléctrica caracteriza a los metaloides como el Telurio?",
          "answer": "Son semiconductores: su conductividad eléctrica es moderada y aumenta al elevar la temperatura o por dopaje.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Telurio (Te, Z=52).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Dónde se ubican los metaloides en la tabla periódica?",
          "answer": "En la línea diagonal divisoria que separa a los metales (a la izquierda) de los no metales (a la derecha).",
          "explanation": "Fundamento analítico de examen de admisión para Telurio (Te).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "54": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿Por qué el Xenón no forma compuestos químicos en condiciones ambientales?",
          "answer": "Porque posee su capa electrónica de valencia completamente saturada (octeto cerrado), con altísima energía de ionización y afinidad electrónica desfavorable.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Xenón (Xe, Z=54).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Cuántos electrones desapareados contiene un átomo neutro de Xenón?",
          "answer": "Cero electrones desapareados; es una especie totalmente diamagnética.",
          "explanation": "Fundamento analítico de examen de admisión para Xenón (Xe).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "55": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación característico del Cesio en todos sus compuestos químicos?",
          "answer": "Estado de oxidación +1 (catión Cs⁺).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Cesio (Cs, Z=55).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué gas se desprende cuando un metal alcalino como el Cesio entra en contacto con agua líquida?",
          "answer": "Gas dihidrógeno (H₂), generándose simultáneamente el hidróxido correspondiente.",
          "explanation": "Fundamento analítico de examen de admisión para Cesio (Cs).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "57": {
    ...
    "z": 57,
    "pedagogy": {
      "everyday_context": "Elemento de las tierras raras (bloque 4f), indispensable en imanes de neodimio-hierro-boro para motores eléctricos, catalizadores y fósforos de pantallas de alta definición.",
      "exam_pitfall": "Estado de oxidación predominante y característico: +3. La 'contracción lantánida' produce que los radios iónicos decrezcan regularmente desde el Lantano hasta el Lutecio, afectando a los metales del bloque d del período 6.",
      "quantum_breakdown": {
        "level_explanation": "Llenado progresivo de los orbitales 4f internos apantallados por las capas 5s, 5p y 6s exteriores.",
        "anomalies_or_rules": "La contracción lantánida explica por qué elementos de la tercera serie de transición (como Hf) tienen radios atómicos casi idénticos a los de la segunda serie (Zr)."
      },
      "family_relationship": "Forma cationes trivalentes La³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Lantano?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Lantano (La, Z=57).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Lantano (La).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "58": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Ce³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Cerio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Cerio (Ce, Z=58).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Cerio (Ce).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "59": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Pr³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Praseodimio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Praseodimio (Pr, Z=59).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Praseodimio (Pr).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "60": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Nd³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Neodimio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Neodimio (Nd, Z=60).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Neodimio (Nd).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "61": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Pm³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Prometio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Prometio (Pm, Z=61).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Prometio (Pm).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "62": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Sm³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Samario?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Samario (Sm, Z=62).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Samario (Sm).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "63": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Eu³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Europio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Europio (Eu, Z=63).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Europio (Eu).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "64": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Gd³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Gadolinio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Gadolinio (Gd, Z=64).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Gadolinio (Gd).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "65": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Tb³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Terbio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Terbio (Tb, Z=65).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Terbio (Tb).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "66": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Dy³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Disprosio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Disprosio (Dy, Z=66).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Disprosio (Dy).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "67": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Ho³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Holmio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Holmio (Ho, Z=67).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Holmio (Ho).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "68": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Er³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Erbio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Erbio (Er, Z=68).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Erbio (Er).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "69": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Tm³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Tulio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Tulio (Tm, Z=69).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Tulio (Tm).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "70": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Yb³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Iterbio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Iterbio (Yb, Z=70).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Iterbio (Yb).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "71": {
    ...
    "pedagogy": {
      ...
      "family_relationship": "Forma cationes trivalentes Lu³⁺ químicamente muy semejantes entre sí, lo que dificulta su separación mineralógica industrial.",
      "misconception": "Pensar que las tierras raras son 'raras' en la corteza terrestre; muchas son más abundantes que la plata o el oro pero dispersas mineralmente.",
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación más estable y característico de los lantánidos como el Lutecio?",
          "answer": "Estado de oxidación +3.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Lutecio (Lu, Z=71).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿A qué fenómeno atómico se debe que los radios atómicos de los lantánidos disminuyan gradualmente a lo largo de la serie?",
          "answer": "A la contracción lantánida: el deficiente apantallamiento de los 14 electrones 4f sobre la carga nuclear creciente.",
          "explanation": "Fundamento analítico de examen de admisión para Lutecio (Lu).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "72": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Hafnio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Hafnio (Hf, Z=72).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Hafnio (Hf).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "73": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Tántalo?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Tántalo (Ta, Z=73).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Tántalo (Ta).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "74": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Wolframio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Wolframio (W, Z=74).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Wolframio (W).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "75": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Renio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Renio (Re, Z=75).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Renio (Re).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "76": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Osmio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Osmio (Os, Z=76).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Osmio (Os).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "77": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Iridio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Iridio (Ir, Z=77).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Iridio (Ir).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "81": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Talio?",
          "answer": "Al bloque p (metales del bloque p o post-transición).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Talio (Tl, Z=81).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué tendencia presentan los puntos de fusión de los metales post-transición frente a los metales de transición?",
          "answer": "Son significativamente más bajos debido a un enlace metálico menos rígido.",
          "explanation": "Fundamento analítico de examen de admisión para Talio (Tl).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "83": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Bismuto?",
          "answer": "Al bloque p (metales del bloque p o post-transición).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Bismuto (Bi, Z=83).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué tendencia presentan los puntos de fusión de los metales post-transición frente a los metales de transición?",
          "answer": "Son significativamente más bajos debido a un enlace metálico menos rígido.",
          "explanation": "Fundamento analítico de examen de admisión para Bismuto (Bi).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "84": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Polonio?",
          "answer": "Al bloque p (metales del bloque p o post-transición).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Polonio (Po, Z=84).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué tendencia presentan los puntos de fusión de los metales post-transición frente a los metales de transición?",
          "answer": "Son significativamente más bajos debido a un enlace metálico menos rígido.",
          "explanation": "Fundamento analítico de examen de admisión para Polonio (Po).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "85": {
    ...
    "z": 85,
    "pedagogy": {
      "everyday_context": "Halógeno no metálico de alta electronegatividad, reactivo y con fuerte tendencia a aceptar electrones para formar sales haluro.",
      "exam_pitfall": "Forma moléculas diatómicas no polares (At₂). Con metales actúa como aceptor formando aniones haluro At⁻ con estado de oxidación −1.",
      "quantum_breakdown": {
        "level_explanation": "Configuración terminal ns² np⁵ con 7 electrones de valencia. Requiere solo 1 electrón para saturar su octeto a gas noble.",
        "anomalies_or_rules": "Afinidad electrónica y poder oxidante elevados. Son los no metales más agresivos y corrosivos de su respectivo período."
      },
      "family_relationship": "Comparte con el Flúor y Cloro la formación de sales haluros alcalinas con redes cristalinas iónicas cúbicas.",
      "misconception": "Creer que los halógenos son metales conductores; son no metales típicamente aislantes con enlaces covalentes moleculares.",
      "self_check_quiz": [
        {
          "question": "¿Cuántos electrones de valencia tiene un halógeno como el Ástato?",
          "answer": "7 electrones de valencia (configuración ns² np⁵).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Ástato (At, Z=85).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Cuál es el estado de oxidación más común del Ástato frente a los metales electropositivos?",
          "answer": "Estado de oxidación −1 (ión haluro At⁻).",
          "explanation": "Fundamento analítico de examen de admisión para Ástato (At).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "86": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿Por qué el Radón no forma compuestos químicos en condiciones ambientales?",
          "answer": "Porque posee su capa electrónica de valencia completamente saturada (octeto cerrado), con altísima energía de ionización y afinidad electrónica desfavorable.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Radón (Rn, Z=86).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Cuántos electrones desapareados contiene un átomo neutro de Radón?",
          "answer": "Cero electrones desapareados; es una especie totalmente diamagnética.",
          "explanation": "Fundamento analítico de examen de admisión para Radón (Rn).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "87": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿Cuál es el estado de oxidación característico del Francio en todos sus compuestos químicos?",
          "answer": "Estado de oxidación +1 (catión Fr⁺).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Francio (Fr, Z=87).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué gas se desprende cuando un metal alcalino como el Francio entra en contacto con agua líquida?",
          "answer": "Gas dihidrógeno (H₂), generándose simultáneamente el hidróxido correspondiente.",
          "explanation": "Fundamento analítico de examen de admisión para Francio (Fr).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "88": {
    ...
    "z": 88,
    "pedagogy": {
      "everyday_context": "Metal alcalinotérreo electropositivo de brillo plateado, usado en metalurgia como desoxidante, aleaciones estructurales y aplicaciones de pirotecnia.",
      "exam_pitfall": "Presenta estado de oxidación fijo de +2 en todos sus compuestos inorgánicos estables. Sus óxidos son básicos y reaccionan con agua para formar hidróxidos divalentes.",
      "quantum_breakdown": {
        "level_explanation": "Configuración electrónica terminal ns² con 2 electrones en su capa de valencia. Es diamagnético en estado neutro fundamental.",
        "anomalies_or_rules": "Presenta radios atómicos menores y puntos de fusión mayores que los metales alcalinos del mismo período por su mayor carga nuclear (+2)."
      },
      "family_relationship": "Comparte con el Calcio y Magnesio la tendencia a ceder 2 electrones formando cationes divalentes estables Ra²⁺.",
      "misconception": "Confundir la solubilidad de sus sulfatos: en el Grupo 2 la solubilidad de los sulfatos disminuye drásticamente hacia abajo (BaSO₄ es insoluble).",
      "self_check_quiz": [
        {
          "question": "¿Cuántos electrones de valencia posee el átomo neutro de Radio y cuál es su valencia habitual?",
          "answer": "Posee 2 electrones de valencia en su subnivel s exterior y actúa con valencia 2 (estado +2).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Radio (Ra, Z=88).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué tipo de óxido forma el Radio al combinarse con oxígeno elemental?",
          "answer": "Forma un óxido básico de fórmula RaO.",
          "explanation": "Fundamento analítico de examen de admisión para Radio (Ra).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "89": {
    ...
    "z": 89,
    "pedagogy": {
      "everyday_context": "Elemento radiactivo de la serie de actínidos (bloque 5f). Elementos como el Uranio y Plutonio son fundamentales en reactores nucleares de generación eléctrica y tecnología nuclear médica.",
      "exam_pitfall": "Todos los actínidos son inestables y radiactivos. A diferencia de los lantánidos, presentan mayor variedad de estados de oxidación (+3, +4, +5, +6) debido a la menor diferencia de energía entre los orbitales 5f y 6d.",
      "quantum_breakdown": {
        "level_explanation": "Llenado progresivo del subnivel cuántico 5f. Núcleos atómicos pesados sujetos a desintegración alfa, beta o fisión espontánea.",
        "anomalies_or_rules": "Su inestabilidad nuclear los convierte en elementos de interés en física nuclear y radioprotección."
      },
      "family_relationship": "Pertenece a la serie f del período 7; los elementos transuránicos (Z > 92) son todos artificiales producidos en reactores o aceleradores de partículas.",
      "misconception": "Creer que todos los actínidos existen en la naturaleza; a partir del Neptunio (Z=93) son elementos sintéticos de origen humano.",
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Actinio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Actinio (Ac, Z=89).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Actinio (Ac).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "90": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Torio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Torio (Th, Z=90).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Torio (Th).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "91": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Protactinio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Protactinio (Pa, Z=91).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Protactinio (Pa).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "92": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Uranio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Uranio (U, Z=92).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Uranio (U).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "93": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Neptunio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Neptunio (Np, Z=93).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Neptunio (Np).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "94": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Plutonio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Plutonio (Pu, Z=94).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Plutonio (Pu).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "95": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Americio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Americio (Am, Z=95).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Americio (Am).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "96": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Curio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Curio (Cm, Z=96).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Curio (Cm).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "97": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Berkelio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Berkelio (Bk, Z=97).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Berkelio (Bk).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "98": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Californio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Californio (Cf, Z=98).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Californio (Cf).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "99": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Einstenio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Einstenio (Es, Z=99).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Einstenio (Es).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "100": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Fermio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Fermio (Fm, Z=100).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Fermio (Fm).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "101": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Mendelevio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Mendelevio (Md, Z=101).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Mendelevio (Md).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "102": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Nobelio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Nobelio (No, Z=102).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Nobelio (No).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "103": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Laurencio?",
          "answer": "Al bloque f (serie de actínidos, orbitales 5f).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Laurencio (Lr, Z=103).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué propiedad nuclear define a todos los miembros de la serie de los actínidos?",
          "answer": "Que todos sus isótopos son radiactivos e inestables.",
          "explanation": "Fundamento analítico de examen de admisión para Laurencio (Lr).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "104": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Rutherfordio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Rutherfordio (Rf, Z=104).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Rutherfordio (Rf).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "105": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Dubnio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Dubnio (Db, Z=105).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Dubnio (Db).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "106": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Seaborgio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Seaborgio (Sg, Z=106).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Seaborgio (Sg).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "107": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Bohrio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Bohrio (Bh, Z=107).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Bohrio (Bh).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "108": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Hassio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Hassio (Hs, Z=108).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Hassio (Hs).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "109": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Meitnerio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Meitnerio (Mt, Z=109).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Meitnerio (Mt).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "110": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Darmstadtio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Darmstadtio (Ds, Z=110).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Darmstadtio (Ds).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "111": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Roentgenio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Roentgenio (Rg, Z=111).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Roentgenio (Rg).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "112": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿De qué nivel cuántico se desprenden los electrones al ionizarse un metal de transición como el Copernicio?",
          "answer": "Se desprenden primero del nivel s más externo antes que del subnivel d interno.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Copernicio (Cn, Z=112).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Por qué los metales de transición presentan múltiples estados de oxidación?",
          "answer": "Porque la diferencia de energía entre los electrones ns y (n-1)d es muy pequeña, permitiendo que ambos participen en los enlaces químicos.",
          "explanation": "Fundamento analítico de examen de admisión para Copernicio (Cn).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "113": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Nihonio?",
          "answer": "Al bloque p (metales del bloque p o post-transición).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Nihonio (Nh, Z=113).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué tendencia presentan los puntos de fusión de los metales post-transición frente a los metales de transición?",
          "answer": "Son significativamente más bajos debido a un enlace metálico menos rígido.",
          "explanation": "Fundamento analítico de examen de admisión para Nihonio (Nh).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "114": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Flerovio?",
          "answer": "Al bloque p (metales del bloque p o post-transición).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Flerovio (Fl, Z=114).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué tendencia presentan los puntos de fusión de los metales post-transición frente a los metales de transición?",
          "answer": "Son significativamente más bajos debido a un enlace metálico menos rígido.",
          "explanation": "Fundamento analítico de examen de admisión para Flerovio (Fl).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "115": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Moscovio?",
          "answer": "Al bloque p (metales del bloque p o post-transición).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Moscovio (Mc, Z=115).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué tendencia presentan los puntos de fusión de los metales post-transición frente a los metales de transición?",
          "answer": "Son significativamente más bajos debido a un enlace metálico menos rígido.",
          "explanation": "Fundamento analítico de examen de admisión para Moscovio (Mc).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "116": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿A qué bloque cuántico de la tabla periódica pertenece el Livermorio?",
          "answer": "Al bloque p (metales del bloque p o post-transición).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Livermorio (Lv, Z=116).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Qué tendencia presentan los puntos de fusión de los metales post-transición frente a los metales de transición?",
          "answer": "Son significativamente más bajos debido a un enlace metálico menos rígido.",
          "explanation": "Fundamento analítico de examen de admisión para Livermorio (Lv).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "117": {
    ...
    "pedagogy": {
      "everyday_context": "Halógeno no metálico de alta electronegatividad, reactivo y con fuerte tendencia a aceptar electrones para formar sales haluro.",
      "exam_pitfall": "Forma moléculas diatómicas no polares (Ts₂). Con metales actúa como aceptor formando aniones haluro Ts⁻ con estado de oxidación −1.",
      "quantum_breakdown": {
        "level_explanation": "Configuración terminal ns² np⁵ con 7 electrones de valencia. Requiere solo 1 electrón para saturar su octeto a gas noble.",
        "anomalies_or_rules": "Afinidad electrónica y poder oxidante elevados. Son los no metales más agresivos y corrosivos de su respectivo período."
      },
      ...
      "self_check_quiz": [
        {
          "question": "¿Cuántos electrones de valencia tiene un halógeno como el Teneso?",
          "answer": "7 electrones de valencia (configuración ns² np⁵).",
          "explanation": "Explicación rigurosa de química preuniversitaria para Teneso (Ts, Z=117).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Cuál es el estado de oxidación más común del Teneso frente a los metales electropositivos?",
          "answer": "Estado de oxidación −1 (ión haluro Ts⁻).",
          "explanation": "Fundamento analítico de examen de admisión para Teneso (Ts).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
  ...
  "118": {
    ...
    "pedagogy": {
      ...
      "self_check_quiz": [
        {
          "question": "¿Por qué el Oganesón no forma compuestos químicos en condiciones ambientales?",
          "answer": "Porque posee su capa electrónica de valencia completamente saturada (octeto cerrado), con altísima energía de ionización y afinidad electrónica desfavorable.",
          "explanation": "Explicación rigurosa de química preuniversitaria para Oganesón (Og, Z=118).",
          "concept_tested": "Propiedades periódicas y estados de oxidación",
          "exam_tag": "Concepto Clave"
        },
        {
          "question": "¿Cuántos electrones desapareados contiene un átomo neutro de Oganesón?",
          "answer": "Cero electrones desapareados; es una especie totalmente diamagnética.",
          "explanation": "Fundamento analítico de examen de admisión para Oganesón (Og).",
          "concept_tested": "Reactividad química y nomenclatura",
          "exam_tag": "Admisión Preuniversitaria"
        }
      ]
...
export function getElementPedagogy(identifier) {
  if (!identifier) return null;
  if (typeof identifier === 'number') return pedagogyData[identifier] || null;
  const num = parseInt(identifier, 10);
  if (!isNaN(num)) return pedagogyData[num] || null;
  const symClean = String(identifier).trim().toLowerCase();
  const found = Object.values(pedagogyData).find(e => e.symbol.toLowerCase() === symClean);
  return found || null;
}
